        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div
              ...
              tabIndex="-1"
              role="dialog"
              aria-labelledby="turtleModalLabel"
              aria-hidden="true"
            >
              <div className="modal-dialog" role="document">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title" id="turtleModalLabel">
                      {this.state.activeTurtle.type}
                    </h5>
                    <button
                      type="button"
                      className="close"
                  ...
                  <div className="modal-body">
                    <img
                      className="rounded"
                      src={this.state.activeTurtle.image_url}
                      alt={this.state.activeTurtle.type}
                    />
                    <h4 className="mt-3">{this.state.activeTurtle.type}</h4>
                    <hr />
                    <dl>
                      <dt>Locations:</dt>
                      <dd>{this.state.activeTurtle.locations}</dd>
                      <dt>Size:</dt>
                      <dd>{this.state.activeTurtle.size}</dd>
                      <dt>Average Lifespan:</dt>
                      <dd>{this.state.activeTurtle.lifespan}</dd>
                      <dt>Diet:</dt>
                      <dd>{this.state.activeTurtle.diet}</dd>
                      <dt>Description:</dt>
                      <dd>{this.state.activeTurtle.description}</dd>
                    </dl>
                  </div>
